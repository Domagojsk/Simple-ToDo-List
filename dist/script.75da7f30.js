...
function addTodo(event) {
  ...
  var newLiTodo = document.createElement('li');
  newLiTodo.classList.add('todo-item');
  newLiTodo.innerText = todoInput.value; // append newLiTodo to todoDiv

  todoDiv.appendChild(newLiTodo); //   Complete btn

  var completedBtn = document.createElement('button');
  completedBtn.classList.add('complete-btn');
  completedBtn.innerHTML = '<i class="fa-solid fa-circle-check"></i>'; //   append completedBtn to todoDiv

  todoDiv.appendChild(completedBtn); //   Delete btn

  var deletedBtn = document.createElement('button');
  deletedBtn.classList.add('delete-btn');
  deletedBtn.innerHTML = '<i class="fa-solid fa-trash-can"></i>'; //   append deleteBtn to todoDiv

  todoDiv.appendChild(deletedBtn); //   Attach to todoDiv to Html UL

  todoItems.appendChild(todoDiv); // Clear input textarea
...
function deleteCheck(e) {
  var item = e.target; // Delete todo item
...
function filterTodo(e) {
  var todos = todoItems.childNodes;
